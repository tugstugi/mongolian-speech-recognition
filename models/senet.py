...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, cardinality, base_width, expansion):
        ...
        if True: # in_channels != out_channels: fix striding problem
...
class SeResNeXt(nn.Module):
    def __init__(self, cardinality, depth, num_classes, base_width, expansion=4):
        ...
        self.stage_1 = self.block('stage_1', self.stages[0], self.stages[1], (2,1))
        self.stage_2 = self.block('stage_2', self.stages[1], self.stages[2], (2,1))
        #self.stage_3 = self.block('stage_3', self.stages[2], self.stages[3], (2,1))
        ...
        for bottleneck in range(self.block_depth):
            ...
            if bottleneck == 0:
                ...
                block.add_module(name_,
                                 Bottleneck(out_channels, out_channels, pool_stride, self.cardinality, self.base_width,
                                            self.expansion))
        return block
